...
public class Main {
	...
	public static void main(String[] args) throws IOException, JSONException {
		...
		TelegramBot bot = TelegramBotAdapter.build("1014446695:AAHYhsgLp-2fl0yvu-DMczs_8zO8uO1g9Jc");
		...
		while (true){
			...
			for (Update update : updates) {
				...
				JSONObject obj = json.getData("https://viacep.com.br/ws/"+update.message().text()+"/json/");
